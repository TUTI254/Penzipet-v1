...
*/
   ...
   class Mpesa
  {
      ...
      function __construct() { 
        ...
        $this->consumer_key       = 'QSCAOAkITYmY8zWmGtb3OU6fUufWywQc';
        $this->consumer_secret    = 'QlQVe9xxRaUGJKSW';
        $this->shortcode          = '174379';
        $this->shortcode1         = ' ';
        $this->shortcode2         = ' ';
        $this->initiatorName      = 'testapi';
        $this->initiatorPass      = 'Safaricom999!';
        $this->confirmation_url   = 'https://ce0c-197-248-131-181.ngrok.io/patazoneFinal/payments/confirmation_url';
        $this->validation_url     = 'https://ce0c-197-248-131-181.ngrok.io/patazoneFinal/payments/validation_url';
        $this->callback_url       = 'https://ce0c-197-248-131-181.ngrok.io/patazoneFinal/payments/stkCallback';
        $this->result_url         = 'https://ce0c-197-248-131-181.ngrok.io/patazoneFinal/payments/result_url';
        $this->timeout_url        = 'https://ce0c-197-248-131-181.ngrok.io/patazoneFinal/payments/timeout_url';
    ...
    */
    ...
    {
        //$key = file_get_contents('myapi/cert/cert.cer');
        $key = $this->cert();
        $rsa = new Crypt_RSA();
        $rsa->loadKey($key);
    ...
    /** The HTTP listener is needed to a server that receive traffic over internet
     * on local host use an http tunneling client ngrok or localtunnel to get a public IP that will enable your localhost  to receive traffic over the internet
     */
    public function http_server_listener()
    { 
